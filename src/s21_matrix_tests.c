...
START_TEST(sum_test_ERROR_matrix) {
  matrix_t A, B, R;
  s21_create_matrix(1, 1, &A);
...
START_TEST(sub_test_ERROR_matrix) {
  matrix_t A, B, R;
  s21_create_matrix(1, 1, &A);
  s21_create_matrix(2, 1, &B);
...
START_TEST(mult_ERROR_matrix_1) {
  matrix_t m1 = {0};
  matrix_t m2 = {0};
...
START_TEST(mult_ERROR_matrix_2) {
  matrix_t m1 = {0};
  matrix_t m2 = {0};
  s21_create_matrix(5, 5, &m1);
  s21_create_matrix(6, 6, &m2);
...
int _test(void) {
  ...
  tcase_add_test(tCase, create_ERROR);
  // s21_remove_matrix
  // s21_eq_matrix
  ...
  tcase_add_test(tCase, sum_test_ERROR_matrix);
  ...
  tcase_add_test(tCase, sub_test_ERROR_matrix);
  tcase_add_test(tCase, sub_null);
  // s21_mult_matrix
  tcase_add_loop_test(tCase, mult_matrix, 0, 100);
  tcase_add_test(tCase, mult_ERROR_matrix_1);
  tcase_add_test(tCase, mult_ERROR_matrix_2);
  tcase_add_test(tCase, mult_matrix_test_1);
  tcase_add_test(tCase, mult_matrix_test_2);
  tcase_add_test(tCase, mult_matrix_test_3);
  // s21_mult_number
  ...
  tcase_add_test(tCase, transpose_ERROR);
  ...
  tcase_add_test(tCase, inverse_ERROR);
